...
// node_modules/use-match-media/index.js
var import_react = __toESM(require_react());
function useMatchMedia(query) {
  const mediaQueryList = window.matchMedia(query);
  const [match2, setMatch] = (0, import_react.useState)(mediaQueryList.matches);
...
useMatchMedia.usePrefersColorScheme = function usePrefersColorScheme() {
  ...
  const [schema, setScheme] = (0, import_react.useState)(mqlLight.matches ? "light" : mqlDark.matches ? "dark" : null);
  (0, import_react.useEffect)(() => {
